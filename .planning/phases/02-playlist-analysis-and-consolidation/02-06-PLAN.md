...
Expected: All new types present alongside existing ones.
  ...
  <done>
src/types/analysis.ts contains all original types plus AlgorithmMode, ConfidenceLevel, AnalysisSession, ConfidenceInfo, SplitInput, DuplicateResolution, RunAnalysisResult, StalenessCheck, AnalysisSummary, VideoDetail, CategoryMetrics. ConsolidationProposal updated with new optional fields. TypeScript compiles.
  </done>
</task>
...
Import all new types from '@/types/analysis'. Import AlgorithmMode, calculateConfidence, clusterPlaylists, and schema tables as needed.
  </action>
  <verify>
Run: `npx tsc --noEmit`
...
- resolveDuplicates updates resolvedPlaylistId
