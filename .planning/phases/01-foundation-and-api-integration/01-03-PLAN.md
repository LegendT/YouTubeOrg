...
must_haves:
  ...
  key_links:
    ...
    - from: "src/lib/rate-limiter.ts"
      ...
      via: "Quota consumption tracking after API calls"
      pattern: "trackQuotaUsage"
---
...
This wrapper automatically tracks quota consumption and prevents exceeding limits.
  </action>
  <verify>
Check exports exist:
```bash
